...
class DefaultController extends Controller {
    ...
    /**
     * @Route("/account", name="url_account")
     */
    public function userAction() {
        $user = $this->get('security.context')->getToken()->getUser();
        return $this->renderSection("account", array(
    ...
    /**
     * @Route("/secured/roles", name="url_roles")
     */
    public function rolesAction() {
        return $this->renderSection("roles");
    }
    /**
    ...
    public function listpageAction($bundle, $entity) {
     ...
     /**
      * @Route("/serial", name="url_serial")
      * @Template()
      */
     public function serialAction() {
         $request = $this->getRequest();

         return $this->renderSection("serial", array(
         ));
     }
     /**
      * @Route("/secured/seriales", name="url_serials")
      * @Template()
      */
     public function serialsAction() {
         return $this->renderSection("serials", array(
         ));
     }
}
