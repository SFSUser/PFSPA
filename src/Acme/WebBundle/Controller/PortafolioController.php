...
class PortafolioController extends Controller {
    ...
    public function acercaAction($id = 0) {
        ...
        if ($acerca_first === null) {
            return $this->redirect($this->generateUrl("url_missing", array("msg" => "La sección de nosotros esta vacía.")), 301);
        }
    ...
    public function indexAction($id = 0, $ca = 0) {
        ...
        if ($first_portafolio === null) {
            return $this->redirect($this->generateUrl("url_missing", array("msg" => "La sección de portafolio esta vacía.")), 301);
        }
        ...
        if ($s > 0) {
            ...
            $fps = $repo_portafolio->find($servicio->getCategoria());
            $first_portafolio = $fps !== null ? $fps : $first_portafolio;
        } else {
            $servicio = $first_portafolio_service;
        }

        if ($first_portafolio_service === null) {
            return $this->redirect($this->generateUrl("url_missing", array("msg" => "La sección de servicios esta vacía.")), 301);
        }
