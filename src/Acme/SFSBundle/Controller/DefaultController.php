...
class DefaultController extends Controller {
    ...
    public static function getDBNameFromDomain() {
     ...
     /**
      * @Route("/is_login", name="url_logged")
      */
     public function isloggedaAction() {
        $user = $this->getUser();
    ...
    public function mysqlAction() {
        ...
        $html = "";
        $input_h = "<input onclick='this.select()' value='";
        //$html .= "<b>Select DB</b>: " . $this->getDoctrine()->getConnection()->get . "<br>";
        $html .= "<b>SSH Hostname</b>: $input_h" . getEnv("OPENSHIFT_APP_DNS") . "'/><br>";
        $html .= "<b>SSH Username</b>: $input_h" . getEnv("OPENSHIFT_GEAR_UUID") . "'/><br>";
        $html .= "<b>MySQL Hostname</b>: $input_h" . getEnv("OPENSHIFT_MYSQL_DB_HOST") . "'/><br>";
        $html .= "<b>MySQL Server Port</b>: $input_h" . getEnv("OPENSHIFT_MYSQL_DB_PORT") . "'/><br>";
        $html .= "<b>MySQL Username</b>: $input_h" . getEnv("OPENSHIFT_MYSQL_DB_USERNAME") . "'/><br>";
        $html .= "<b>MySQL Password</b>: $input_h" . getEnv("OPENSHIFT_MYSQL_DB_PASSWORD") . "'/><br>";
        $html .= "<b>MySQL Database</b>: $input_h" . getEnv("OPENSHIFT_APP_NAME") . "'/><br>";
